...
async def analyze_reviews(request: AnalysisRequestSchema):
    ...
    # Извлекаем ID товара из URL или используем как есть
    product_id: str
    ...
    try:
        ...
        # Получаем результаты анализа всех текстов
        ...
        # Собираем статистику по тональности
        ...
        # Собираем все аспекты для категоризации
        ...
        # Получаем объединенные и категоризированные аспекты
        ...
        # Группируем аспекты по категориям для подсчета
...
async def analyze_sentiment_single(text: str = Body(..., embed=True)):
    ...
    try:
        # Используем новый метод analyze_sentiment_single

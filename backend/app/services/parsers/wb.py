...
class WildberriesParser:
    ...
    def is_valid_product_id(self, product_id: str) -> bool:
        """Проверяет, является ли строка допустимым ID товара WB (число или строка цифр)"""
